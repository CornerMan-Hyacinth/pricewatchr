...
@router.post("/", response_model=ResponseModel[ProductUrlInDB], status_code=status.HTTP_201_CREATED)
...
@router.get("/product/{product_id}", response_model=ResponseModel[List[ProductUrlInDB]])
...
@router.get("/{pu_id}", response_model=ResponseModel[ProductUrlInDB])
...
@router.put("/{pu_id}", response_model=ResponseModel[ProductUrlInDB])
...
@router.delete("/{pu_id}", response_model=ResponseModel[None])
